...
fun CanvasArea(
    ...
    // BoxWithConstraints provides available space constraints
    BoxWithConstraints(
        ...
        val (canvasWidth, canvasHeight) = if (aspectRatio >= 1f) {
        ...
        Box(
            modifier = Modifier
                .border(width = 2.dp, color = Color.Gray.copy(alpha = 0.4f))
